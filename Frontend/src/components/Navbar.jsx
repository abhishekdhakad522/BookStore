...
export const Navbar = () => {
    ...
    // Sync theme to DaisyUI and Tailwind, and persist
    useEffect(() => {
            ...
            >
                <div className="navbar ">
                    ...
                    <div className="navbar-end space-x-3">
                        ...
                        <div className="">
                            <a className="btn bg-white text-black dark:bg-black dark:text-white px-x py-2 rounded-md hover:bg-slate-800 hover:text-white duration-300 cursor-pointer "
